...
| yarilo original | (this branch HEAD) | Suppress expunge in pre-OK poll for all commands except EXPUNGE/UID EXPUNGE/CLOSE/UNSELECT; flush after tagged OK via pollExpunge (fix #314) |
